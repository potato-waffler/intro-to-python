...
def is_first_of_the_month(day_number):
  if day_number == 1:
    ...
    return "Not first of the month" # Return "Not first of the month" otherwise.
...
def has_five_chars(the_str):
  if len(the_str) == 5:
    return f"{the_str} is five characters long"  # Return "STRING is five characters long" if the string
  # is five characters long.
  else:
    return "Not five characters" # Otherwise, return "Not five characters".
